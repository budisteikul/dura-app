...
@php
$contents = \App\Classes\Rev\BokunClass::get_product_list_byid('25671');
@endphp
<section id="tour" style="background-color:#ffffff">
<div class="container">
	<div class="row">
...
@php
$contents = \App\Classes\Rev\BokunClass::get_product_list_byid('27223');
@endphp
<section id="tour" style="background-color:#ffffff">
<div class="container">
	<div class="row">
...
@php
$contents = \App\Classes\Rev\BokunClass::get_product_list_byid('27224');
@endphp
<section id="tour" style="background-color:#ffffff">
<div class="container">
	<div class="row">
