...
<link href="/css/ratnawahyu-1.1.1.css" rel="stylesheet" media="screen,handheld">
@endpush
  ...
  <nav class="navbar navbar-default navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">{{ $setting->title }}</a>
	...
	<header id="page-top" class="intro-header" style="background-image: url('/assets/ratnawahyu/DHwfJfutCkQi4hkxbsr7MbHWhd76K0IsNjhyqhiB.jpeg'); background-color:#000000">
    	...
    	<div class="site-heading text-center">
        	<div class="transbox" style="min-height:100px; padding-top:25px; padding-bottom:25px; padding-left:10px; padding-right:10px;">
				<img class="img-circle" height="100" src="{{ asset($setting->gravatar) }}">
			...
			<div class="timeline-panel" style="background-color:#FFFFFF; margin-right:4px; margin-left:4px;">
				...
				<div class="timeline-body">
                    ...
                    @foreach($result->attachments as $attachment)
						...
						{
						?>
                        		<img id="{{ $attachment->id }}" onClick="openFancyBox('{{ $result->id }}','{{ $index }}','{{ $attachment->id }}'); return false;" class="image-photo" src="{{ \App\Classes\Blog\BlogClass::cloudinary_url($setting->user_id.'/images/original/'.$attachment->file_name,250) }}" alt=""  />
						...
						{
						?>
                        		<img id="{{ $attachment->id }}" onClick="openFancyBox('{{ $result->id }}','{{ $index }}','{{ $attachment->id }}'); return false;" class="image-photo" src="{{ \App\Classes\Blog\BlogClass::cloudinary_url($setting->user_id.'/images/original/'.$attachment->file_name,500) }}" alt=""  />
