...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-4 col-sm-auto  mb-4">
    	...
    	<div class="card mb-4 shadow p-4 card-block d-table-cell align-middle" style="height:200px;">
  				 <img class="card-img-top" src="/assets/foodtour/partner/original-food-tours____.jpg" alt="Ninja Food Tours">
			</div>
    </div>
    ...
    <div class="col-sm-4 col-sm-auto  mb-4">
			...
			<div class="card mb-4 shadow p-4 card-block d-table-cell align-middle" style="height:200px;">
  				 <img class="card-img-top" src="/assets/foodtour/partner/cancun-food-tours.png" alt="Ninja Food Tours">
			</div>
    </div>

    <div class="col-sm-4 col-sm-auto mb-4">
    	<div class="card mb-4 shadow p-4 card-block d-table-cell align-middle" style="height:200px;">
  				 <img class="card-img-top" src="/assets/foodtour/partner/india-food-tours.jpg" alt="Ninja Food Tours">
		</div>
    </div>

    <div class="col-sm-4 col-sm-auto mb-4">
    	<div class="card mb-4 shadow p-4 card-block d-table-cell align-middle" style="height:200px;">
  				 <img class="card-img-top" src="/assets/foodtour/partner/trinidad.jpg" alt="Ninja Food Tours">
		</div>
    </div>

    <div class="col-sm-4 col-sm-auto mb-4">
    	<div class="card mb-4 shadow p-4 card-block d-table-cell align-middle" style="height:200px;">
  				 <img class="card-img-top" src="/assets/foodtour/partner/jogja.png" alt="Ninja Food Tours">
		</div>
    </div>
