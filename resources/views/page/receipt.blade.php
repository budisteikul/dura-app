			...
			<div class="col-lg-6 col-lg-auto mb-6 mt-4">
                ...
                <div class="card shadow">
					...
					<div class="card-body">
                        ...
                        <p>
						<h3>Receipt</h3>
						<a target="_blank" class="text-danger" href="/booking/invoice/{{ $customer->bookingId }}/{{$customer->sessionId}}"><i class="far fa-file-pdf"></i> Invoice-{{ $customer->confirmationCode }}.pdf</a>
						<h3>Experience tickets</h3>
                        @foreach($rev_shoppingcarts as $rev_shoppingcart)
                        <a target="_blank" class="text-danger" href="/booking/ticket/{{ $rev_shoppingcart->productConfirmationCode }}/{{$customer->sessionId}}"><i class="far fa-file-pdf"></i> Ticket-{{ $rev_shoppingcart->productConfirmationCode }}.pdf</a>
                        <br>
                        @endforeach
                        </p>
