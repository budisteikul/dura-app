...
class WebhookController extends Controller
{
    ...
    public function store(Request $request)
    {
        $mail = Mail_Account::where('email',$request->input('recipient'))->first();
			...
			{
				$MailHeader = MailClass::mail_header($request->input('message-headers'));
			...
			$pushover_user = MailClass::get_option('pushover_user',$user_id);
			$pushover_app = MailClass::get_option('pushover_app',$user_id);
