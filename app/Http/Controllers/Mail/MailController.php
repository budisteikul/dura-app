...
class MailController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('mails.create')->with('mail_accounts',$mail_accounts);
    }
    ...
    public function store(Request $request)
    {
		...
		{	
			...
			$mail_email->attachment_count = @count($mail_attachments) + @count($mail_old_attachments);
			$mail_email->attachment_x = @count($mail_attachments) + @count($mail_old_attachments);
    ...
    public function show($id,$view="")
    {
		...
		else
		{
			...
			return view('mails.show-no-layout')->with('mail',$mail)
											  ->with('view',$view);
		}
	}
    ...
    public function edit($id, Request $request)
    {
		...
		if($request=='reply')
		{
			$mail_recipient = $mail_email->sender;
        ...
        return view('mails.edit')->with('mail_accounts',$mail_accounts)
