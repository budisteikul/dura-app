		...
		return $this->builder()
                    ...
                    ->parameters([
						...
						'preDrawCallback' => 'function() { 
							...
							$(\'.toolbar\').empty().append(\'<ul class="pagination"><li class="paginate_button"><a onClick="return SELECTALL_CHECKBOX()"><i id="check_all" class="fa fa-square-o"></i></a></li>'. $archive_button .'<li class="paginate_button"><a onClick="return DELETE()"><i class="fa fa-trash-o"></i></a></li></ul>\');
